...
const materialData = [
  ...
  { Kategori: "Golv", Artikel: "Trallgolv", Enhet: "m2", MangdPerM2: 1.0, Enhetstid: 0.15, Inkopspris: 195, Forsaljningspris: 350, TaMed: true, Notering: "Beräknas på golvyta" },
  ...
  { Kategori: "Golv", Artikel: "Trossbottenpapp", Enhet: "m2", MangdPerM2: 1.0, Enhetstid: 0.05, Inkopspris: 25, Forsaljningspris: 45, TaMed: true, Notering: "Beräknas på golvyta" },
  { Kategori: "Golv", Artikel: "Spånskivegolv", Enhet: "m2", MangdPerM2: 1.0, Enhetstid: 0.10, Inkopspris: 95, Forsaljningspris: 160, TaMed: true, Notering: "Beräknas på golvyta" },
  { Kategori: "Golv", Artikel: "Isolering golv", Enhet: "m2", MangdPerM2: 1.0, Enhetstid: 0.08, Inkopspris: 75, Forsaljningspris: 125, TaMed: true, Notering: "Beräknas på golvyta" },
